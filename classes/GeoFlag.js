...
export default class GeoFlag {
  ...
  static list (codes) {
    ...
    for (const code of codes) {
      list[code] = this.get(code)
    }

    return list
  }

  static country (code, lang = undefined) {
    return {
      icon: this.get(code),
      text: new Geo(lang).getDisplay(code, 'region'),
      textLang: new Geo(code).getDisplay(code, 'region'),
      value: code
    }
  }
